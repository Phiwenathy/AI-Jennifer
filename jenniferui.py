...
class UiJenniferWindow(object):
    def setupUi(self, jennifer_window):
        ...
        jennifer_window.setWindowIcon(QIcon('../photos/Picture9.png'))
        ...
        self.background_label.setPixmap(QtGui.QPixmap(
            "../photos/abstract-frame-technology-futuristic-interface-hud-vector.jpg"))
        ...
        self.loading_label.setPixmap(QtGui.QPixmap("../photos/load.gif"))
        self.loading_label.setScaledContents(True)
        self.loading_label.setObjectName("loading_label")
        self.loading_movie = QMovie('../photos/load.gif')
        ...
        self.date_label.setPixmap(QtGui.QPixmap("../photos/element.jpg"))
        ...
        self.time_label.setPixmap(QtGui.QPixmap("../photos/element.jpg"))
        ...
        self.temperature_label.setPixmap(QtGui.QPixmap("../photos/element.jpg"))
        ...
        self.voice_label.setPixmap(QtGui.QPixmap("../photos/Aqua.gif"))
        self.voice_label.setScaledContents(True)
        self.voice_label.setObjectName("voice_label")
        self.voice_movie = QMovie('../photos/Aqua.gif')
        ...
        self.cmd_button.setStyleSheet(
            "background-image: url(../photos/cmd.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.powerpoint_button.setStyleSheet(
            "background-image: url(../photos/Picture8.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.notepadplus_button.setStyleSheet(
            "background-image: url(../photos/Picture5.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.snip_tool_button.setStyleSheet(
            "background-image: url(../photos/edge2.jpg);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.excel_button.setStyleSheet(
            "background-image: url(../photos/Picture7.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.youtube_button.setStyleSheet(
            "background-image: url(../photos/youtube1.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.telegram_button.setStyleSheet(
            "background-image: url(../photos/telegram.png);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.pycharm_button.setStyleSheet(
            "background-image: url(../photos/py.jpg);\nbackground-size: cover;"
            "\nbackground-repeat: no-repeat;\nborder: none;")
        ...
        self.lara2_movie = QMovie('../photos/lara2.gif')
        ...
        self.jennifer_label.setPixmap(QtGui.QPixmap("../photos/animal.gif"))
        self.jennifer_label.setScaledContents(True)
        self.jennifer_label.setObjectName("jennifer_label")
        self.jennifer_movie = QMovie('../photos/animal.gif')
        ...
        self.lara3_movie = QMovie('../photos/lara3.gif')
        ...
        self.ironman_movie = QMovie('../photos/lara4.gif')
        ...
        self.battery_label.setPixmap(QtGui.QPixmap(
            "../photos/—Pngtree—futuristic display frame gaming_5745334.png"))
        ...
        # self.battery_value.setGraphicsEffect(shadow_effect)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        # self.swap_value.setGraphicsEffect(shadow_effect)
        ...
        # self.ram_value.setGraphicsEffect(shadow_effect)
        ...
        # self.cpu_value.setGraphicsEffect(shadow_effect)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.start_button.setStyleSheet(
            "background-image: url(../photos/Startb.png);\nborder:none;"
            "\nbackground-repeat: no-repeat;")
        ...
        self.pause_button.setStyleSheet(
            "background-image: url(../photos/pauseb.png);\nborder:none;"
            "\nbackground-repeat: no-repeat;")
        ...
        self.stop_button.setStyleSheet(
            "background-image: url(../photos/stopt.png);\nborder:none;"
            "\nbackground-repeat: no-repeat;")
        ...
        self.download_label.setPixmap(QtGui.QPixmap("../photos/download.png"))
        ...
        self.upload_label.setPixmap(QtGui.QPixmap("../photos/up.png"))
        ...
        self.ram_space_label.setPixmap(QtGui.QPixmap("../photos/Picture11.png"))
        ...
        # self.space_used_value.setGraphicsEffect(shadow_effect)
        ...
        # self.free_space_value.setGraphicsEffect(shadow_effect)
        ...
        self.usercard_label.setPixmap(QtGui.QPixmap("../photos/card.jpg"))
        ...
        self.user_value.setPixmap(QtGui.QPixmap(
            "../photos/photo_2021-05-15_21-49-08.jpg"))
